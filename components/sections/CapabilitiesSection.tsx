...
function CapabilityCard({ icon, title, description, delay }: CapabilityCardProps) {
  return (
    <motion.div
    ...
    <section className="bg-[#f8f9fa] relative w-full py-[64px] md:py-[80px] lg:py-[100px]">
      <div className="max-w-[1200px] mx-auto px-6 md:px-8">
        ...
        <div className="text-center mx-auto mb-[48px]">
          ...
          >
            {t('titleLine1')} <span className="text-[#00B894]">{t('titleHighlight')}</span>
          </motion.h2>
        </div>
        ...
        <div className="flex flex-col gap-6 mb-6 px-0 md:px-6">
          ...
          >
            <p className="text-[#1a1a2e] text-[16px] leading-[1.7]">
              {t('featuredText')}
            </p>
          </motion.div>
        </div>
