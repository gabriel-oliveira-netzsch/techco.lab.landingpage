 ...
 * 
 * Nota: Não incluímos <html> e <body> porque o layout raiz já os fornece
 */
        ...
        <div className="max-w-[1440px] mx-auto px-6 md:px-8 lg:px-16 py-20 md:py-32 relative z-10">
          <div className="flex flex-col items-center text-center gap-8">
            ...
            <div className="flex flex-wrap gap-4 mt-4 justify-center">
              <Link 
                href="/"
                className="inline-flex gap-2 items-center justify-center px-6 py-3.5 rounded-lg font-semibold text-[16px] text-white transition-colors hover:opacity-90"
              ...
              <Link 
                href="/open-positions"
                className="inline-flex gap-2 items-center justify-center px-6 py-3.5 rounded-lg font-semibold text-[16px] text-white border-2 transition-colors hover:bg-white/10"
